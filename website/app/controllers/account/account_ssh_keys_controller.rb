class Account::AccountSshKeysController < Account::BaseController
  ...
  def create
    ...
    if @ssh_key.save
      redirect_to account_ssh_keys_path, notice: t('view.flash.create', default: 'SSH key was successfully created.')
    else
      render :index
    end
  end
  ...
  def destroy
    ...
    redirect_to account_ssh_keys_path, notice: t('view.flash.destroy', default: 'SSH key was successfully destroyed.')
  end
